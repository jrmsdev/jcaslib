...
extern void str_vjoin (str_type *dst, const char *sep, int count,
                       const char *str, va_list ap);
extern void str_join (str_type *dst, const char *sep, int count,
                      const char *str, ...);
...
extern void str_array_insert (str_array_type *arr, size_t idx,
                              const char *str);
extern void str_array_append (str_array_type *arr, const char *str);

extern str_type * str_array_get (str_array_type *arr, size_t idx);
